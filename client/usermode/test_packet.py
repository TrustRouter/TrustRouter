...
from packet import IPv6, ICMPv6_NDP_PrefixInfo, ICMPv6_NDP_RSASignature, ICMPv6_NDP_Option
...
class TestPacket(TestCase):
    ...
    def testSignatureOption(self):
        ...
        sig_option = self.packet.payload.options[6]
...
if __name__ == '__main__':
    suite = TestSuite()
    suite.addTest(TestPacket('testIPFields'))
    suite.addTest(TestPacket('testRAFields'))
    suite.addTest(TestPacket('testPrefixOptionFields'))
    suite.addTest(TestPacket('testSignatureOption'))
